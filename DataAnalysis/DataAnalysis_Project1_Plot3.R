## Read, name and subset the power consumption dataset.
...
# Transforming the Date and Time from characters into objects of type Date and POSIXlt alike:
...
#file3 <- png("Plot3.png", width=480, height=480)
#file3
